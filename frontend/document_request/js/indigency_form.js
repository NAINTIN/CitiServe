const trail = [
  ...
  { label: "Barangay Indigendcy",  href: 'indigency.php' },
  ...
  function validateForm() {
    ...
    const textFields = [
      ...
      { id: 'purpose',         errorId: 'purposeError' },
    ];
    ...
    if (valid) {
    window.location.href = 'docu_business_payment.php?doc=indigency';
  }
    return valid;
  }
    /* ══════════════════════════
