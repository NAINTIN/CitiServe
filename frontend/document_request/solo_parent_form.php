...
<div class="content-area">
  ...
  <h1 class="form-title">Solo Parent Certificate – Request Form</h1>
...
<div class="form-stepper">
    ...
    <div class="form-main">
      <div class="form-card">
        ...
        <div class="form-card-bar">
          <img src="images/req-docu-sp.png">
          Request Information
        </div>
        ...
        <div class="form-card-body">
          ...
          <div class="form-row-4">
            <div class="form-group">
              <label>First Name (Parent) <span class="req">*</span></label>
          ...
          <!-- Number of Children -->
          <div class="form-group">
            <label>Number of Children <span class="req">*</span></label>
            <input type="number" placeholder="e.g. 3" id="numChildren" min="1">
            <div class="field-error" id="numChildrenError">
              <img src="images/docu-field-required.png">
            </div>
          </div>
          ...
          <!-- Names of Children -->
          <div class="form-group">
            <label>Name(s) of Child/Children (one per line) <span class="req">*</span></label>
            <textarea placeholder="Enter name(s) of child/children (one per line)..." id="childrenNames"></textarea>
            <div class="field-error textarea-error" id="childrenNamesError">
              <img src="images/docu-field-required.png">
            </div>
          </div>

          <!-- Reason for Solo Parenthood + Others -->
          <div class="form-row-2">
            <div class="form-group">
              <label>Reason for Solo Parenthood <span class="req">*</span></label>
              <div class="custom-select" id="reasonDropdown">
                <div class="custom-select-selected" onclick="toggleDropdown('reasonDropdown')">
                  <span class="custom-select-text">Select reason</span>
                  <span class="custom-select-arrow">▾</span>
                </div>
                <div class="custom-select-options">
                  <div class="custom-select-option" onclick="selectOption('reasonDropdown', 'Spouse has died')">Spouse has died</div>
                  <div class="custom-select-option" onclick="selectOption('reasonDropdown', 'Spouse is in jail / detention')">Spouse is in jail / detention</div>
                  <div class="custom-select-option" onclick="selectOption('reasonDropdown', 'Legally Separated')">Legally Separated</div>
                  <div class="custom-select-option" onclick="selectOption('reasonDropdown', 'Abandoned by spouse')">Abandoned by spouse</div>
                    <div class="custom-select-option" onclick="selectOption('reasonDropdown', 'Unwed parent')">Unwed parent</div>
                  <div class="custom-select-option" onclick="selectOption('reasonDropdown', 'Others')">Others</div>
                </div>
              </div>
              <div class="field-error" id="reasonError">
                <img src="images/docu-field-required.png">
              </div>
            </div>
            <div class="form-group">
              <label>Others (Please specify) <span class="req">*</span></label>
              <input type="text" placeholder="Please specify the purpose of the activity" id="reasonOther" class="others-input others-disabled" disabled>
              <div class="field-error" id="reasonOtherError">
                <img src="images/docu-field-required.png">
              </div>
            </div>
          </div>

          <!-- Upload Parent's Valid ID -->
          <div class="form-group">
            <label>Upload Parent's Valid ID <span class="req">*</span></label>
          ...
          <!-- Upload Child's PSA Birth Certificate -->
          <div class="form-group">
            <label>Upload Child's PSA Birth Certificate <span class="req">*</span></label>
            <div class="upload-box upload-box-large" id="psaUpload" onclick="document.getElementById('psaFileInput').click()">
              <div class="upload-default" id="psaDefault">
                <img src="images/click-to-upload.png" class="upload-icon">
                <span>Click to upload file</span>
              </div>
              <img class="upload-preview-img" id="psaPreview">
              <span class="upload-filename" id="psaFilename"></span>
              <input type="file" id="psaFileInput" class="file-input" accept="image/*, application/pdf" style="display:none;">
            </div>
            <small class="upload-note">Upload the PSA-issued birth certificate of your child/children (JPG, PNG, PDF – max 5MB)</small>
            <div class="field-error upload-field-error" id="psaError">
              <img src="images/docu-field-required.png">
            </div>
          </div>
        ...
        <div class="form-btn-row">
          <div class="form-btn-group">
            <button class="form-btn" onclick="hasFilledFields() ? openModal() : window.location.href='solo_parent.php'">
      ...
      <div class="form-card">
        ...
        <div class="form-card-body summary-body">
          <div class="summary-row">
            ...
            <span class="summary-value">Solo Parent Certificate</span>
          </div>
          <div class="summary-row">
  ...
  <div class="modal-box">
    ...
    <div class="modal-btn-group">
      <button onclick="window.location.href='solo_parent.php'" class="modal-btn">
...
<script src="js/solo_parent_form.js"></script>
</body>
</html>
