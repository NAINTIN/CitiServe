...
$isStaffAdmin = $user && ($user->role === 'admin' || $user->role === 'staff');
$navActionHref = $user ? '/CitiServe/public/notifications.php' : '/CitiServe/public/login.php';
$navActionLabel = $user ? ('Notifications (' . (int)$unreadCount . ') 🠚') : 'Login 🠚';
$primaryStartHref = $user
    ? ($isStaffAdmin ? '/CitiServe/public/admin/requests.php' : '/CitiServe/public/services.php')
    : '/CitiServe/public/register.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="/CitiServe/frontend/css/style.css">
    ...
    <style>
        .logout-link { margin-left: 12px; color: #f03871; text-decoration: none; font-weight: 700; }
        .portal-quick-links { max-width: 1200px; margin: 40px auto 20px; padding: 20px; border: 1px solid #f2d7e0; border-radius: 14px; background: #fff; font-family: Epilogue, sans-serif; }
        .portal-quick-links p { margin: 0 0 12px; }
        .portal-quick-links ul { margin: 0; padding-left: 18px; columns: 2; }
        .portal-quick-links a { color: #a21a4d; text-decoration: none; }
        .portal-quick-links a:hover { text-decoration: underline; }
        @media (max-width: 900px) { .portal-quick-links ul { columns: 1; } }
    </style>
</head>
<body>
    ...
    <nav class="navbar" id="navbar">
        <img src="/CitiServe/frontend/images/logo_half.png" class="landing_logo1" id="navLogo">
    ...
    <div class="nav-right">
        ...
        <a href="<?= htmlspecialchars($navActionHref) ?>" class="login-btn"><?= htmlspecialchars($navActionLabel) ?></a>

        <?php if ($user): ?>
        <a href="/CitiServe/public/logout.php" class="logout-link">Logout</a>
        <?php endif; ?>
    </div>
    </nav>
    ...
    <img src="/CitiServe/frontend/images/landing_folder.png" class="landing_folder">

    <div class="hero-content">
        <img src="/CitiServe/frontend/images/landing_location.png" class="landing_location">
        ...
        <a href="<?= htmlspecialchars($primaryStartHref) ?>" class="start-btn">
    ...
    <section id="services" class="services-section">
        <img src="/CitiServe/frontend/images/kalayaan.png" class="bg-left" alt="">
        <img src="/CitiServe/frontend/images/angono 2.png" class="bg-right" alt="">

        <div class="services-top-content">
            <img src="/CitiServe/frontend/images/our services.png" class="services-img" alt="Our Services">
        ...
        <div class="service-cards">
            <div class="service-card yellow-card">
                <img src="/CitiServe/frontend/images/document_icon.png" class="service-card-icon">
            ...
            <div class="service-card pink-card">
                <img src="/CitiServe/frontend/images/compliant_icon.png" class="service-card-icon">
    ...
    <section id="features" class="choose_section">
        <div class="choose_wrapper">
            <div class="choose_top-image">
                <img src="/CitiServe/frontend/images/choose.png" alt="">
            </div>
            ...
            <div class="carousel-container">
                <div class="carousel" id="heroCarousel">
                    <div class="card">
                        <div class="icon"><img src="/CitiServe/frontend/images/availability.png"></div>
                    ...
                    <div class="card">
                        <div class="icon"><img src="/CitiServe/frontend/images/security.png"></div>
                    ...
                    <div class="card">
                        <div class="icon"><img src="/CitiServe/frontend/images/fast.png"></div>
                    ...
                    <div class="card">
                        <div class="icon"><img src="/CitiServe/frontend/images/realtime.png"></div>
                    ...
                    <div class="card">
                        <div class="icon"><img src="/CitiServe/frontend/images/organized.png"></div>
                    ...
                    <div class="card">
                        <div class="icon"><img src="/CitiServe/frontend/images/mobile_responsive.png"></div>
    ...
    <section id="about" class="about_container">
        ...
        <div class="about_left">
            <img src="/CitiServe/frontend/images/captain.png" alt="Captain">
        </div>
        <div class="about_right">

            <div class="about_about">
                <img src="/CitiServe/frontend/images/about.png" alt="About">
            </div>
    ...
    <section class="works-section">
        ...
        <div class="works-bg">
            <img src="/CitiServe/frontend/images/landing_works.png" alt="Background Design">
        </div>

        <div class="works-top-img">
            <img src="/CitiServe/frontend/images/howcitiserve.png" alt="CitiServe Logo">
        </div>
        ...
        <div class="works-cards">
            ...
            <div class="works-card">
                ...
                <img src="/CitiServe/frontend/images/icon1_work.png" class="works-card-icon">
            ...
            <div class="works-card">
                ...
                <img src="/CitiServe/frontend/images/icon2_work.png" class="works-card-icon">
            ...
            <div class="works-card">
                ...
                <img src="/CitiServe/frontend/images/icon3_work.png" class="works-card-icon">
    ...
    <div class="faq-wrapper">
        <div class="faq-left">
            ...
            <div class="faq-decoration">
                <img src="/CitiServe/frontend/images/faq_icon.png" alt="FAQ Decoration">
            </div>
        </div>
    ...
    <section id="contacts" class="contacts-section">
        ...
        <div class="contacts-badge">
            <img src="/CitiServe/frontend/images/contacts.png" alt="Get In Touch" class="badge-icon">
        </div>
        ...
        <div class="contacts-cards">
            ...
            <div class="contact-card">
                <div class="contact-card-icon">
                    <img src="/CitiServe/frontend/images/email.png" alt="Email">
                </div>
                <h3>Email Us</h3>
            ...
            <div class="contact-card">
                <div class="contact-card-icon">
                    <img src="/CitiServe/frontend/images/office.png" alt="Office Hours">
                </div>
                <h3>Office Hours</h3>
            ...
            <div class="contact-card">
                <div class="contact-card-icon">
                    <img src="/CitiServe/frontend/images/visit.png" alt="Visit Us">
                </div>
                <h3>Visit Us</h3>
        ...
        <div class="support-rect">
            <div class="support-icon">
                <img src="/CitiServe/frontend/images/support.png" alt="Support">
            </div>
            ...
            <div class="support-link">
                <img src="/CitiServe/frontend/images/call.png" alt="Call" class="call-icon">
    ...
    <div class="map-section">
        ...
        <div class="map-card">
            <div class="map-card-logo">
                <img src="/CitiServe/frontend/images/logo_pink.png" alt="CitiServe Logo">
            </div>
            ...
            <a href="https://www.facebook.com/bagongbarangaykalayaan" target="_blank" class="map-fb">
                <img src="/CitiServe/frontend/images/fb.png" alt="Facebook">
            </a>
        </div>

        <button class="scroll-top-btn" onclick="window.scrollTo({top: 0, behavior: 'smooth'})">
            <img src="/CitiServe/frontend/images/arrowup.png" alt="Scroll to Top">
        </button>
    </div>
    ...
    <footer class="site-footer">
        ...
        <div class="footer-center">
            <img src="/CitiServe/frontend/images/footer_logo.png" alt="Footer Logos" class="footer-side-logo">
            <img src="/CitiServe/frontend/images/whitelogo_solo.png" alt="CitiServe White Logo" class="footer-main-logo">
        </div>
...
<script src="/CitiServe/frontend/script.js"></script>
</body>
</html>