...
$recentRequests   = [];
$recentComplaints = [];
$announcement     = ['id' => 1, 'img' => 'images/announcement_stack.png'];
...
$upcomingRequestIcons = [
  ...
  'Certificate of Residency'    => 'images/cert_recidency.png',
  'Solo Parent Certificate'     => 'images/cert_soloparent.png',
];

$upcomingRequestIcon = 'images/barangay_clearance.png';
...
<nav class="navbar">
  ...
  <div class="navbar-nav">
    ...
    <div class="nav-item has-dropdown" id="navComplaint">
      ...
      <span class="nav-chevron">⏷</span>
      <div class="nav-dropdown">
        <a href="submit_complaint.php" class="nav-dropdown-item">Submit Complaint</a>
      ...
      <div class="left-col">
        ...
        <div class="greeting-section">
          ...
          <span class="badge-verified">
            <img src="<?= $user['verified'] ? 'images/full_verification.png' : 'images/basic_verification.png' ?>"
              class="badge-img"
        ...
        <div class="action-btns">
          <a href="request_document.php" class="action-btn1">
            <img src="images/main_request_document.png" alt="Request Document">
          </a>
          <a href="submit_complaint.php" class="action-btn2">
            <img src="images/main_submit_complaint.png" alt="Submit Complaint">
          </a>
        </div>
      ...
      <div class="right-col">
        ...
        <div class="stat-row">
          <div class="stat-card featured">
            <a href="document-requests.php?filter=ready" class="stat-arrow">
          ...
          <div class="stat-card">
            <a href="document-requests.php?filter=active" class="stat-arrow">
          ...
          <div class="stat-card">
            <a href="complaints.php?filter=active" class="stat-arrow">
              <img src="images/dashboard_arrow.png" alt="Go">
            </a>
          ...
          <div class="stat-card">
            <a href="notifications.php" class="stat-arrow">
              <img src="images/dashboard_arrow.png" alt="Go">
            </a>
          ...
          <div class="panels-col">
            ...
            <div class="recent-panel">
              <div class="panel-header1">
                ...
                <a href="my-requests.php" class="panel-viewall1">
              ...
              <div class="panel-body">
                ...
                <?php else: ?>
                  <?php foreach ($recentRequests as $r): ?>
                    <?php
                      $requestIcon = $requestIcons[$r['title']] ?? 'images/barangay_clearance.png';
                    ?>
            ...
            <div class="recent-panel complaints">
              <div class="panel-header2">
                ...
                <a href="my-complaints.php" class="panel-viewall2">
              ...
              <div class="panel-body">
                ...
                <?php else: ?>
                  <?php foreach ($recentComplaints as $c): ?>
                    <?php
                      $complaintIcon = $complaintIcons[$c['title']] ?? 'images/other_concerns.png';
                    ?>
