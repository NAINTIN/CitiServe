...
<head>
  ...
  <link rel="stylesheet" href="css/barangay_id_form.css">
</head>
<body>
...
<div class="form-breadcrumb" id="form-breadcrumb"></div>
  ...
  <h1 class="form-title">Barangay ID – Request Form</h1>
    ...
    <div class="form-main">
      <div class="form-card">
        ...
        <div class="form-card-bar">
          <img src="images/req-info-bid.png">
          Request Information
        </div>
        ...
        <div class="form-card-body">
         ...
         <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="custom-select" id="genderDropdown">
                <div class="custom-select-selected" onclick="toggleDropdown('genderDropdown')">
                  <span class="custom-select-text">Select gender</span>
                  <span class="custom-select-arrow">▾</span>
                </div>
                <div class="custom-select-options">
                  <div class="custom-select-option" onclick="selectOption('genderDropdown', 'Male')">Male</div>
                  <div class="custom-select-option" onclick="selectOption('genderDropdown', 'Female')">Female</div>
                </div>
              </div>
              <div class="field-error" id="genderError">
                <img src="images/docu-field-required.png">
              </div>
            </div>
            <div class="form-group">
          ...
          <!-- Upload 1x1 Photo -->
          <div class="form-group">
            <label>Upload 1x1 Photo (white background) <span class="req">*</span></label>
            <div class="upload-box" id="photoUpload" onclick="document.getElementById('photoFileInput').click()">
              <div class="upload-default" id="photoDefault">
                <img src="images/click-to-upload.png" class="upload-icon">
                <span>Click to upload file</span>
              </div>
              <img class="upload-preview-img" id="photoPreview">
              <span class="upload-filename" id="photoFilename"></span>
              <input type="file" id="photoFileInput" class="file-input" accept="image/*" style="display:none;">
            </div>
            <small class="upload-note">Upload a recent 1x1 photo with white background in formal attire (JPG, PNG – max 2MB)</small>
            <div class="field-error upload-field-error" id="photoError">
              <img src="images/docu-field-required.png">
            </div>
          </div>
        ...
        <div class="form-btn-row">
          <div class="form-btn-group">
           <button class="form-btn" onclick="hasFilledFields() ? openModal() : window.location.href='barangay_id.php'">
      ...
      <div class="form-card">
        ...
        <div class="form-card-body summary-body">
          <div class="summary-row">
            ...
            <span class="summary-value">Barangay ID</span>
          </div>
          <div class="summary-row">
            <span class="summary-label">Fee</span>
            <span class="summary-fee">₱75.00</span>
          </div>
        </div>
      </div>
  ...
  <div class="modal-box">
    ...
    <div class="modal-btn-group">
      <button onclick="window.location.href='barangay_id.php'" class="modal-btn">
...
<script src="js/barangay_id_form.js"></script>
</body>
</html>
