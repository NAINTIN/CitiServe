...
<div class="content-area">
  ...
  <h1 class="form-title">Certificate of Indigency – Request Form</h1>
      ...
      <div class="form-card">
        ...
        <div class="form-card-body">
          ...
          <div class="form-row-2">
            ...
            <div class="form-group">
              ...
              <input type="number" placeholder="e.g. 67" id="age" min="0" max="120">
          ...
          <div class="form-group">
            ...
            <textarea placeholder="Enter purpose (e.g., medical assistance, scholarship)…" id="purpose"></textarea>
        ...
        <div class="form-btn-row">
          <div class="form-btn-group">
            <button class="form-btn" onclick="hasFilledFields() ? openModal() : window.location.href='indigency.php'">
      ...
      <div class="form-card">
        ...
        <div class="form-card-body summary-body">
          <div class="summary-row">
            ...
            <span class="summary-value">Certificate of Indigency</span>
          </div>
          <div class="summary-row">
            <span class="summary-label">Fee</span>
            <span class="summary-fee">₱20.00</span>
          </div>
        </div>
      </div>
...
<script src="js/indigency_form.js"></script>
